...
const works = [
  ...
  },
  {
    ...
    theme: "c",
    art: "SURVEY",
    title: "瑞幸咖啡市场调查（问卷 · SPSS 交叉分析 · 实地 · 声量）",
    short: "瑞幸市场调查",
    role: "市场调研 · 问卷设计 + SPSS 分析",
    year: "2024",
    summary:
      "围绕瑞幸咖啡开展的完整市场调查：设计并发放咖啡消费行为问卷，用 SPSS 做专业与性别交叉分析，结合中山路旗舰店实地洞察与网络声量分析（巨量算数 / 百度指数 / 微信指数），产出数据与结论兼备的调查报告。",
    bullets: [
      "问卷设计与回收 · SPSS 交叉分析",
  ...
  },
  {
    ...
    year: "2024–2025",
    summary:
      "校园欺凌题材公益广告提案：从社会议题切入，完成创意概念、分镜头脚本与影视策划案，以公益传播呼吁更多人关注校园欺凌问题。",
    bullets: [
      "公益广告创意概念与提案",
      "分镜头脚本 + 影视策划案",
      "🔍 提案 PDF 可放大预览",
    ],
    media: { type: "pdf", file: "assets/pdf/校园欺凌公益广告提案.pdf", label: "校园欺凌公益广告提案（PDF）", hint: "🔍 放大查看完整提案" },
  },
  {
    id: "shot-design",
    cat: "video",
    ...
    year: "2024",
    summary:
      "非线编课程镜头设计作业：完成分镜方案与「摄影机与人物站位」设计，展示对机位、构图与人物调度的基础把控能力。",
    bullets: [
      "分镜设计与镜头语言",
      "摄影机与人物站位设计",
      "🔍 镜头设计 PDF 可放大预览",
    ],
    coverImg: "assets/img/镜头设计.jpg",
    media: { type: "pdf", file: "assets/pdf/非线编-镜头设计.pdf", label: "镜头设计（PDF）", hint: "🔍 放大查看完整设计" },
  },
];
